...
public class View {
    ...
    public void showView(){
        ...
        while(inicializador){
            ...
            try{
                JsonNode node = JsonUtil.MAPPER.readTree(new File("C:\\projetos\\projects\\sistema_cadastro\\sistema-cadastro\\menu.json"));
    ...
    public void buscarPet(){
        mostrarMsgLn("Informe o critério de busca do Pet: ");
        mostrarMsgLn("Nome ou Sobrenome");
        mostrarMsgLn("Sexo");
        mostrarMsgLn("Idade");
        mostrarMsgLn("Peso");
        mostrarMsgLn("Raça");
        mostrarMsgLn("Endereço");
        mostrarMsg("Escolha: ");
    }
